...
export { DEFAULT_CAPTION_FONT_SIZE_PX, actionCount, addTapZone, addWidget, applyFontFamilyToDashboard, deleteWidget, draftFontFamily, draftValueFont, duplicateWidget, insertWidget, offsetWidget } from './editor/widgets'
