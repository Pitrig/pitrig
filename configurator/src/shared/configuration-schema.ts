...
export const SCHEMA_OBJECT_KEYS: Record<string, readonly string[]> = {
  ...
  BarWidgetConfiguration: ['type', 'id', 'placement', 'z_index', 'padding', 'border', 'title', 'background_color', 'background_grad_color', 'background_grad_dir', 'background_inset_px', 'fill_corners', 'action', 'condition_source', 'color_ramp', 'conditions', 'source', 'minimum', 'maximum', 'origin', 'orientation', 'inverted', 'fill_color', 'fill_grad_color', 'fill_grad_mid_color'],
  ArcWidgetConfiguration: ['type', 'id', 'placement', 'z_index', 'padding', 'border', 'title', 'background_color', 'background_grad_color', 'background_grad_dir', 'background_inset_px', 'fill_corners', 'action', 'condition_source', 'color_ramp', 'conditions', 'source', 'minimum', 'maximum', 'center_angle_deg', 'sector_deg', 'thickness_px', 'radius_px', 'x_offset_px', 'y_offset_px', 'centering', 'track_color', 'fill_color', 'fill_grad_color', 'fill_grad_mid_color', 'mark', 'inverted'],
