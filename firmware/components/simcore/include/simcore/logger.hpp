...
void debug(const char* tag, const char* format, ...) __attribute__((format(printf, 2, 3)));
void verbose(const char* tag, const char* format, ...) __attribute__((format(printf, 2, 3)));
