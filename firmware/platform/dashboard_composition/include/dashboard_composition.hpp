...
[[nodiscard]] bool show_startup_screen(
    lv_display_t* display, const configuration::ApplicationConfiguration& configuration);

void dismiss_startup_screen(const configuration::ApplicationConfiguration& configuration,
                            bool wait_for_minimum);

[[nodiscard]] bool load_fonts(Dashboard& dashboard, const font_assets::Service& font_assets,
...
[[nodiscard]] bool images_available(const configuration::ApplicationConfiguration& configuration,
                                    const image_assets::Service& image_assets,
                                    const Dashboard& dashboard);

[[nodiscard]] bool images_loaded(const configuration::ApplicationConfiguration& configuration,
                                 const Dashboard& dashboard);

[[nodiscard]] bool start_render_trigger(Dashboard& dashboard, events::EventBus& event_bus);
...
[[nodiscard]] bool fonts_available(const configuration::ApplicationConfiguration& configuration,
                                   const Dashboard& dashboard);

[[nodiscard]] bool apply_incremental(const configuration::ApplicationConfiguration& previous,
