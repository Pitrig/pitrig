...
struct TextWidgets : WidgetStorage {
  ...
  static constexpr auto kPool = &configuration::DashboardConfiguration::text_widgets;
...
struct ShapeWidgets : WidgetStorage {
  ...
  static constexpr auto kPool = &configuration::DashboardConfiguration::shape_widgets;

  dashboard::frame::ConditionBinder<Config, dashboard::shape_widget::kMaximumInstances> binder;
...
struct SlotWidgets : WidgetStorage {
  ...
  static constexpr auto kPool = &configuration::DashboardConfiguration::slot_widgets;
...
struct BarWidgets : WidgetStorage {
  ...
  static constexpr bool kSmoothsSource = true;
  static constexpr auto kPool = &configuration::DashboardConfiguration::bar_widgets;

  dashboard::frame::ValueBinder<Config, dashboard::bar_widget::kMaximumInstances> binder;
...
struct ArcWidgets : WidgetStorage {
  ...
  static constexpr bool kSmoothsSource = true;
  static constexpr auto kPool = &configuration::DashboardConfiguration::arc_widgets;

  dashboard::frame::ValueBinder<Config, dashboard::arc_widget::kMaximumInstances> binder;
...
struct IndicatorWidgets : WidgetStorage {
  ...
  static constexpr auto kPool = &configuration::DashboardConfiguration::indicator_widgets;

  dashboard::frame::ValueBinder<Config, dashboard::indicator_widget::kMaximumInstances> binder;
...
struct GraphWidgets : WidgetStorage {
  ...
  static constexpr bool kSmoothsSource = true;
  static constexpr auto kPool = &configuration::DashboardConfiguration::graph_widgets;
...
struct ImageWidgets : WidgetStorage {
  ...
  static constexpr auto kPool = &configuration::DashboardConfiguration::image_widgets;
...
struct Dashboard {
  ...
  std::array<std::int32_t, configuration::kMaximumShapeWidgets> container_overflow{};
  std::array<lv_obj_t*, dashboard::slot_widget::kMaximumPages> pages{};
  std::array<std::int32_t, dashboard::slot_widget::kMaximumPages> page_overflow{};
  ...
  dashboard::boot_splash::Splash splash;
#if PITRIG_DEBUG
  dashboard::overlays::Views overlays;
#endif
